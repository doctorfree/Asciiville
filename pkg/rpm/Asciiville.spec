...
Release:    %{_release}
BuildArch:  x86_64
Requires: python3, python3-pip, tilix, xfce4-terminal, cool-retro-term, gnome-terminal, tmux, mplayer, lynx, w3m, mutt, ranger, jq, asciinema, speedtest-cli, caca-utils, neofetch, figlet, ruby
