...
Release:    %{_release}
BuildArch:  x86_64
Requires: util-linux, python3, python3-pip, tmux, mplayer, w3m, ranger, jq, asciinema, speedtest-cli, neofetch, figlet, ImageMagick, dconf, libjpeg-turbo, libpng, cmatrix, gnupg, pandoc
