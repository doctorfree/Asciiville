...
BINS = bin/asciiart bin/asciijulia bin/asciimpplus bin/asciiplasma \
	   ...
	   bin/bb-tmux bin/btop-tmux bin/make_ascii_art \
	   bin/set_xfce_trans bin/show_ascii_art
...
.PHONY: all info deb rpm aewan btop cbftp jp2a nethack ninvaders clean

all: aewan btop cbftp jp2a nethack ninvaders deb rpm
